...
export interface IProductRepository {
  create(data: Omit<Produto, 'id' | 'custoMedio' | 'ativo' | 'curvaAbc'>): Promise<Produto>;
  ...
  getRupturesKpi(): Promise<{ totalCurvaA: number; rupturasCurvaA: number; porcentagem: number }>;
}
