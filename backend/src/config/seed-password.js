...
function resolveSeedPassword() {
    ...
    if (process.env.SEED_ADMIN_PASSWORD) {
        return { password: process.env.SEED_ADMIN_PASSWORD, isDev: isDev };
    }
    ...
    throw new Error('\n\n❌ ERRO CRÍTICO DE SEED — Ambiente não-desenvolvimento detectado.\n' +
        "   NODE_ENV=\"".concat(nodeEnv, "\" mas SEED_ADMIN_PASSWORD n\u00E3o est\u00E1 definida.\n") +
